...
def attendanceDetail(request, pk):
    ...
    for attendee in all:
        ...
        elif attendee.volunteers.Volunteer == True and attendee.attendee.Are_you_a_pastor == False:
            Workers.append(attendee)
        elif attendee.volunteers.Volunteer == False and attendee.attendee.Are_you_a_pastor == False:
